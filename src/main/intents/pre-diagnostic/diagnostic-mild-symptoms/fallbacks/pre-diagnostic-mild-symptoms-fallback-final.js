...
import { responseDiagnosticMildSymptomsFallbackFinal } from '../../../../responses'
import { UtilsIntents } from '../../../utils/utils-intents'

export class PreDiagnosticMildSymptomsFallbackFinal {
  static execute (agent) {
    ...
    UtilsIntents.setResponse(agent, responseDiagnosticMildSymptomsFallbackFinal)
  }
}
